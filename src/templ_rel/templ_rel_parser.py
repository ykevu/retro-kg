def add_model_opts(parser):
    """Model options"""
    group = parser.add_argument_group("template_relevance")
    group.add_argument(
        "--data_name", help="Data name", type=str, default="Template Relevance"
    )
    group.add_argument(
        "--model_name", help="Model name", type=str, default="Template Relevance"
    )
